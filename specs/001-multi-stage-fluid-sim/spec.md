...
- Each LED cell in the Display Frame is treated as on/off (binary occupancy), consistent with the existing prototype's visual convention, rather than requiring per-cell brightness/dimming control.
